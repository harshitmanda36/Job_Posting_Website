    ...
    //   const applicationFormId = match.params.id; // Assuming you're using React Router for routing
      ...
      useEffect(() => {
        const fetchApplicationForm = async () => {
          try {
            const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/application/65f696b53e4f77429e7245ce`);
    ...
    console.log(response.data)
      ...
      const handleDownloadResume = async() => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/application/resume/65f696b53e4f77429e7245ce`, {
