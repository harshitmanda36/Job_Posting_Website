...
const JsProfile = ({ loginData, username }) => {
    ...
    if (newSkill.trim() !== "") {
      ...
      try {
        const response = await axios.put(
          `${process.env.REACT_APP_API_BASE_URL}/api/js/${loginData._id}/skills`,
  ...
  const handleSkillDelete = async (index) => {
    ...
    try {
      await axios.put(`${process.env.REACT_APP_API_BASE_URL}/api/js/${loginData._id}/skills`, {
  ...
  const handleExpSave = async () => {
    ...
    try {
      const response = await axios.put(
        `${process.env.REACT_APP_API_BASE_URL}/api/js/${loginData._id}/workexp`,
  ...
  const handleEduSave = async () => {
    ...
    try {
      const response = await axios.put(
        `${process.env.REACT_APP_API_BASE_URL}/api/js/${loginData._id}/education`,
        { education: editedEdu },
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const handlePersonalInfoSave = async () => {
    ...
    try {
      const response = await axios.put(
        `${process.env.REACT_APP_API_BASE_URL}/api/js/${loginData._id}/personal-details`,
        editedPersonalInfo,
        {
          headers: {
            "Content-Type": "application/json",
