...
const EmployerBoard = () => {
  ...
  const fetchJobSeekerData = async (jsID) => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_BASE_URL}/api/jsdetails/${jsID}`,
        {
          headers: {
  ...
  const getRecievedApplications = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_BASE_URL}/api/employerapplications/${loginCompanyData.companyName}`,
  ...
  const getJobs = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_BASE_URL}/api/jobs/${loginCompanyData.companyName}`,
